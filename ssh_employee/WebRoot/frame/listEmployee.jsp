...
<td align="center"><a href="${pageContext.request.contextPath }/employee_edit.action?eid=<s:property value="#e.eid"/>"><img src="../images/编辑.png"></a></td>
<td align="center"><a href="${pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="../images/删除.png" onclick="return confirm('确认删除吗?');"></a></td>
</tr>
</s:iterator>
</tbody>
</table>
